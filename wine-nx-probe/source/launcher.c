/*
 * The runtime's launcher: a console menu of the Windows programs under
 * drive_c, driven by the controller. It runs before Wine starts, so choosing
 * another program means starting the runtime again.
 */
#include <switch.h>
