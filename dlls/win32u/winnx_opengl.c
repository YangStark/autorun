...
/* While an OpenGL surface owns the NWindow, the normal Wine compositor is
 * suspended. Draw the physical mouse arrow into that surface before swap.
 * Scissored colour clears avoid changing the game's shaders or vertex state. */
